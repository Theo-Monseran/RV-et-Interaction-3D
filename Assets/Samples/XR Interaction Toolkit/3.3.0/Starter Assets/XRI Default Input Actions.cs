...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Pause"",
            ""id"": ""e3762a46-7734-4a78-b062-d441c4b27452"",
            ""actions"": [
                {
                    ""name"": ""PauseToggle"",
                    ""type"": ""Button"",
                    ""id"": ""30de2540-265e-4bc6-864b-bf7386cd5567"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""8e2421f0-9963-4677-9718-b50ee0b1c475"",
    ...
    ""controlSchemes"": []
        ...
        m_Pause_PauseToggle = m_Pause.FindAction("PauseToggle", throwIfNotFound: true);
    }
    ...
    ~@XRIDefaultInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Pause.enabled, "This will cause a leak and performance issues, XRIDefaultInputActions.Pause.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Pause_PauseToggle;
    /// <summary>
    ...
    public struct PauseActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PauseActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Pause/PauseToggle".
        /// </summary>
        public InputAction @PauseToggle => m_Wrapper.m_Pause_PauseToggle;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
